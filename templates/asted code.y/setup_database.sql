...
-- 1. Rebuild clean tables to ensure all schema attributes match our new structural engine
...
CREATE TABLE bookings (
    ...
    seats_reserved VARCHAR(100) NOT NULL,
    price_paid INT NOT NULL
);

-- 2. Populate over 20 diverse, realistic train routes crisscrossing key regions
